...
class ProductSearchUI(private val viewModel: ProductSearchViewModel): AnkoComponent<ProductSearchActivity> {
    ...
    override fun createView(ui: AnkoContext<ProductSearchActivity>) =
        ui.verticalLayout {
            recyclerView {
                ...
                bindPagedList(ui.owner, ProductListPagedAdapter(viewModel), viewModel.products)
            }
